...
public final class AnimCube extends Applet implements Runnable, MouseListener, MouseMotionListener {
  ...
  public void setCubo(Cubo c){ // Anadido octubre-2008
    cube[0][6] = c.caras[0].casillas[0] + 10;
    cube[0][7] = c.caras[0].casillas[1] + 10;
    cube[0][8] = c.caras[0].casillas[2] + 10;
    cube[0][5] = c.caras[0].casillas[3] + 10;
    cube[0][2] = c.caras[0].casillas[4] + 10;
    cube[0][1] = c.caras[0].casillas[5] + 10;
    cube[0][0] = c.caras[0].casillas[6] + 10;
    cube[0][3] = c.caras[0].casillas[7] + 10;
    cube[0][4] = c.caras[0].casillas[8] + 10;
    
    cube[1][0] = c.caras[5].casillas[0] + 10;
    cube[1][3] = c.caras[5].casillas[1] + 10;
    cube[1][6] = c.caras[5].casillas[2] + 10;
    cube[1][7] = c.caras[5].casillas[3] + 10;
    cube[1][8] = c.caras[5].casillas[4] + 10;
    cube[1][5] = c.caras[5].casillas[5] + 10;
    cube[1][2] = c.caras[5].casillas[6] + 10;
    cube[1][1] = c.caras[5].casillas[7] + 10;
    cube[1][4] = c.caras[5].casillas[8] + 10;
     
    cube[2][0] = c.caras[2].casillas[0] + 10;
    cube[2][3] = c.caras[2].casillas[1] + 10;
    cube[2][6] = c.caras[2].casillas[2] + 10;
    cube[2][7] = c.caras[2].casillas[3] + 10;
    cube[2][8] = c.caras[2].casillas[4] + 10;
    cube[2][5] = c.caras[2].casillas[5] + 10;
    cube[2][2] = c.caras[2].casillas[6] + 10;
    cube[2][1] = c.caras[2].casillas[7] + 10;
    cube[2][4] = c.caras[2].casillas[8] + 10;

    cube[3][0] = c.caras[4].casillas[0] + 10;
    cube[3][3] = c.caras[4].casillas[1] + 10;
    cube[3][6] = c.caras[4].casillas[2] + 10;
    cube[3][7] = c.caras[4].casillas[3] + 10;
    cube[3][8] = c.caras[4].casillas[4] + 10;
    cube[3][5] = c.caras[4].casillas[5] + 10;
    cube[3][2] = c.caras[4].casillas[6] + 10;
    cube[3][1] = c.caras[4].casillas[7] + 10;
    cube[3][4] = c.caras[4].casillas[8] + 10;

    cube[4][2] = c.caras[1].casillas[0] + 10;
    cube[4][1] = c.caras[1].casillas[1] + 10;
    cube[4][0] = c.caras[1].casillas[2] + 10;
    cube[4][3] = c.caras[1].casillas[3] + 10;
    cube[4][6] = c.caras[1].casillas[4] + 10;
    cube[4][7] = c.caras[1].casillas[5] + 10;
    cube[4][8] = c.caras[1].casillas[6] + 10;
    cube[4][5] = c.caras[1].casillas[7] + 10;
    cube[4][4] = c.caras[1].casillas[8] + 10;

    cube[5][0] = c.caras[3].casillas[0] + 10;
    cube[5][3] = c.caras[3].casillas[1] + 10;
    cube[5][6] = c.caras[3].casillas[2] + 10;
    cube[5][7] = c.caras[3].casillas[3] + 10;
    cube[5][8] = c.caras[3].casillas[4] + 10;
    cube[5][5] = c.caras[3].casillas[5] + 10;
    cube[5][2] = c.caras[3].casillas[6] + 10;
    cube[5][1] = c.caras[3].casillas[7] + 10;
    cube[5][4] = c.caras[3].casillas[8] + 10;
    
    repaint(); 
  }
  
  
  public Cubo getCubo(){ // Anadido octubre-2008
      Cubo nc = new Cubo();
      nc.caras[0].casillas[0] = (byte) (cube[0][6] - 10);
      nc.caras[0].casillas[1] = (byte) (cube[0][7] - 10);
      nc.caras[0].casillas[2] = (byte) (cube[0][8] - 10);
      nc.caras[0].casillas[3] = (byte) (cube[0][5]  - 10);
      nc.caras[0].casillas[4] = (byte) (cube[0][2] - 10);
      nc.caras[0].casillas[5] = (byte) (cube[0][1] - 10);
      nc.caras[0].casillas[6] = (byte) (cube[0][0] - 10);
      nc.caras[0].casillas[7] = (byte) (cube[0][3]- 10);
      nc.caras[0].casillas[8] = (byte) (cube[0][4] - 10);
    
     nc.caras[5].casillas[0] = (byte) (cube[1][0] - 10);
     nc.caras[5].casillas[1] = (byte) (cube[1][3] - 10);
     nc.caras[5].casillas[2] = (byte) (cube[1][6] - 10);
     nc.caras[5].casillas[3] = (byte) (cube[1][7] - 10);
     nc.caras[5].casillas[4] = (byte) (cube[1][8] - 10);
     nc.caras[5].casillas[5] = (byte) (cube[1][5] - 10);
     nc.caras[5].casillas[6] = (byte) (cube[1][2] - 10);
     nc.caras[5].casillas[7] = (byte) (cube[1][1] - 10);
     nc.caras[5].casillas[8] = (byte) (cube[1][4] - 10);
     
    nc.caras[2].casillas[0] = (byte) (cube[2][0]- 10); 
    nc.caras[2].casillas[1] = (byte) (cube[2][3]- 10); 
    nc.caras[2].casillas[2] = (byte) (cube[2][6]- 10); 
    nc.caras[2].casillas[3] = (byte) (cube[2][7]- 10); 
    nc.caras[2].casillas[4] = (byte) (cube[2][8]- 10); 
    nc.caras[2].casillas[5] = (byte) (cube[2][5]- 10); 
    nc.caras[2].casillas[6] = (byte) (cube[2][2]- 10); 
    nc.caras[2].casillas[7] = (byte) (cube[2][1]- 10); 
    nc.caras[2].casillas[8] = (byte) (cube[2][4]- 10); 

    nc.caras[4].casillas[0] = (byte) (cube[3][0]- 10); 
    nc.caras[4].casillas[1] = (byte) (cube[3][3]- 10); 
    nc.caras[4].casillas[2] = (byte) (cube[3][6]- 10); 
    nc.caras[4].casillas[3] = (byte) (cube[3][7]- 10); 
    nc.caras[4].casillas[4] = (byte) (cube[3][8]- 10);
    nc.caras[4].casillas[5] = (byte) (cube[3][5]- 10); 
    nc.caras[4].casillas[6] = (byte) (cube[3][2]- 10);
    nc.caras[4].casillas[7] = (byte) (cube[3][1]- 10); 
    nc.caras[4].casillas[8] = (byte) (cube[3][4]- 10); 

    nc.caras[1].casillas[0] = (byte) (cube[4][2]- 10);
    nc.caras[1].casillas[1] = (byte) (cube[4][1]- 10); 
    nc.caras[1].casillas[2] = (byte) (cube[4][0]- 10);
    nc.caras[1].casillas[3] = (byte) (cube[4][3]- 10); 
    nc.caras[1].casillas[4] = (byte) (cube[4][6]- 10);
    nc.caras[1].casillas[5] = (byte) (cube[4][7]- 10); 
    nc.caras[1].casillas[6] = (byte) (cube[4][8]- 10);
    nc.caras[1].casillas[7] = (byte) (cube[4][5]- 10); 
    nc.caras[1].casillas[8] = (byte) (cube[4][4]- 10);

    nc.caras[3].casillas[0] = (byte) (cube[5][0]- 10);         
    nc.caras[3].casillas[1] = (byte) (cube[5][3]- 10); 
    nc.caras[3].casillas[2] = (byte) (cube[5][6]- 10); 
    nc.caras[3].casillas[3] = (byte) (cube[5][7]- 10); 
    nc.caras[3].casillas[4] = (byte) (cube[5][8]- 10); 
    nc.caras[3].casillas[5] = (byte) (cube[5][5]- 10); 
    nc.caras[3].casillas[6] = (byte) (cube[5][2]- 10); 
    nc.caras[3].casillas[7] = (byte) (cube[5][1]- 10); 
    nc.caras[3].casillas[8] = (byte) (cube[5][4]- 10); 
  ...
  public String getParameter(String name) { // Modificado octubre-2008
  ...
  public void mouseMoved(MouseEvent e) {
    ...
    if (!description.equals((Object) buttonDescription)) {
